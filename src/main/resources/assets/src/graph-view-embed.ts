...
import { GraphDataContainer, TokenTreeNode } from './types';
...
function makeProps(graphData: TokenTreeNode) {
    return {
        width: 800,
        height: 800,
        xMargin: 0,
